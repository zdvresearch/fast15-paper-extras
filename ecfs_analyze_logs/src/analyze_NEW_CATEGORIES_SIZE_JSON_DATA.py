...
def argparse_of_program():
    ...
    #parser.add_argument('-o','--output', help='Output plot name, % bytes requested within a size range, get and put', required=True)
    #parser.add_argument('-a','--output2', help='Output plot name, % # requests within a size range, get and put', required=True)
    #parser.add_argument('-a2','--output3', help='Output plot name, month requests PUT (%) in function of size', required=True)
...
def plot_numrequests_permonth_stackedbysize(gray_scale_r, x_axis_r, variable_r, width_r, tags_r, list_of_ranges_r, outplotfilename):
    ...
    # offset = 0
    # label_index = 0
    # for all_sizes in range(1, len(list_of_ranges_r), 1):
    #     for all_months in range(1, len(tags_r), 1):
    #
    #         if all_sizes is 1:
    #
    #             plt.bar(x_axis_r[all_months-1], variable_r[all_sizes-1][all_months-1], width_r, color=gray_scale_r[all_sizes-1], label=list_of_ranges_r[0])
    #         else:
    #             offset += variable_r[all_sizes-2][all_months-1]
    #
    #             plt.bar(x_axis_r[all_months-1], variable_r[all_sizes-1][all_months-1], width_r, color=gray_scale_r[all_sizes-1], bottom=offset)
    # #plt.legend(loc='upper right', fontsize=20)
    # plt.show()
    #for all_months in range(1, len(tags_r), 1):

    # numbers are correct, the way are plotted it's wrong, please fix this

    zebra = 0
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[0][all_months-1], width_r, color=gray_scale_r[0], label=list_of_ranges_r[0])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[0][all_months-1], width_r, color=gray_scale_r[0])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[1][all_months-1], width_r, color=gray_scale_r[1], bottom=variable_r[0][all_months-1], label=list_of_ranges_r[1])
            zebra += 1

        else:
            plt.bar(x_axis_r[all_months-1], variable_r[1][all_months-1], width_r, color=gray_scale_r[1], bottom=variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        ...
        if zebra is 0:
            ...
            plt.bar(x_axis_r[all_months-1], variable_r[2][all_months-1], width_r, color=gray_scale_r[2], bottom=variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[2])
            zebra += 1

        else:
            plt.bar(x_axis_r[all_months-1], variable_r[2][all_months-1], width_r, color=gray_scale_r[2], bottom=variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[3][all_months-1], width_r, color=gray_scale_r[3], bottom=variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[3])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[3][all_months-1], width_r, color=gray_scale_r[3], bottom=variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[4][all_months-1], width_r, color=gray_scale_r[4], bottom=variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[4])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[4][all_months-1], width_r, color=gray_scale_r[4], bottom=variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[5][all_months-1], width_r, color=gray_scale_r[5], bottom=variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[5])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[5][all_months-1], width_r, color=gray_scale_r[5], bottom=variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[6][all_months-1], width_r, color=gray_scale_r[6], bottom=variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[6])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[6][all_months-1], width_r, color=gray_scale_r[6], bottom=variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[7][all_months-1], width_r, color=gray_scale_r[7], bottom=variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[7])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[7][all_months-1], width_r, color=gray_scale_r[7], bottom=variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[8][all_months-1], width_r, color=gray_scale_r[8], bottom=variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[8])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[8][all_months-1], width_r, color=gray_scale_r[8], bottom=variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[9][all_months-1], width_r, color=gray_scale_r[9], bottom=variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[9])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[9][all_months-1], width_r, color=gray_scale_r[9], bottom=variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[10][all_months-1], width_r, color=gray_scale_r[10], bottom=variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[10])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[10][all_months-1], width_r, color=gray_scale_r[10], bottom=variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[11][all_months-1], width_r, color=gray_scale_r[11], bottom=variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[11])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[11][all_months-1], width_r, color=gray_scale_r[11], bottom=variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[12][all_months-1], width_r, color=gray_scale_r[12], bottom=variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[12])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[12][all_months-1], width_r, color=gray_scale_r[12], bottom=variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[13][all_months-1], width_r, color=gray_scale_r[13], bottom=variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[13])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[13][all_months-1], width_r, color=gray_scale_r[13], bottom=variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[14][all_months-1], width_r, color=gray_scale_r[14], bottom=variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[14])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[14][all_months-1], width_r, color=gray_scale_r[14], bottom=variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[15][all_months-1], width_r, color=gray_scale_r[15], bottom=variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[15])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[15][all_months-1], width_r, color=gray_scale_r[15], bottom=variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[16][all_months-1], width_r, color=gray_scale_r[16], bottom=variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[16])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[16][all_months-1], width_r, color=gray_scale_r[16], bottom=variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[17][all_months-1], width_r, color=gray_scale_r[17], bottom=variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[17])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[17][all_months-1], width_r, color=gray_scale_r[17], bottom=variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[18][all_months-1], width_r, color=gray_scale_r[18], bottom=variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[18])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[18][all_months-1], width_r, color=gray_scale_r[18], bottom=variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[19][all_months-1], width_r, color=gray_scale_r[19], bottom=variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[19])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[19][all_months-1], width_r, color=gray_scale_r[19], bottom=variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[20][all_months-1], width_r, color=gray_scale_r[20], bottom=variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[20])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[20][all_months-1], width_r, color=gray_scale_r[20], bottom=variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[21][all_months-1], width_r, color=gray_scale_r[21], bottom=variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[21])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[21][all_months-1], width_r, color=gray_scale_r[21], bottom=variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[22][all_months-1], width_r, color=gray_scale_r[22], bottom=variable_r[21][all_months-1]+variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[22])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[22][all_months-1], width_r, color=gray_scale_r[22], bottom=variable_r[21][all_months-1]+variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[23][all_months-1], width_r, color=gray_scale_r[23], bottom=variable_r[22][all_months-1]+variable_r[21][all_months-1]+variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[23])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[23][all_months-1], width_r, color=gray_scale_r[23], bottom=variable_r[22][all_months-1]+variable_r[21][all_months-1]+variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        #zebra = 0
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[24][all_months-1], width_r, color=gray_scale_r[24], bottom=variable_r[23][all_months-1]+variable_r[22][all_months-1]+variable_r[21][all_months-1]+variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[24])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[24][all_months-1], width_r, color=gray_scale_r[24], bottom=variable_r[23][all_months-1]+variable_r[22][all_months-1]+variable_r[21][all_months-1]+variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
    ...
    for all_months in range(1, len(tags_r)+1, 1):
        ...
        if zebra is 0:
            plt.bar(x_axis_r[all_months-1], variable_r[25][all_months-1], width_r, color=gray_scale_r[25], bottom=variable_r[24][all_months-1]+variable_r[23][all_months-1]+variable_r[22][all_months-1]+variable_r[21][all_months-1]+variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1], label=list_of_ranges_r[25])
            zebra += 1
        else:
            plt.bar(x_axis_r[all_months-1], variable_r[25][all_months-1], width_r, color=gray_scale_r[25], bottom=variable_r[24][all_months-1]+variable_r[23][all_months-1]+variable_r[22][all_months-1]+variable_r[21][all_months-1]+variable_r[20][all_months-1]+variable_r[19][all_months-1]+variable_r[18][all_months-1]+variable_r[17][all_months-1]+variable_r[16][all_months-1]+variable_r[15][all_months-1]+variable_r[14][all_months-1]+variable_r[13][all_months-1]+variable_r[12][all_months-1]+variable_r[11][all_months-1]+variable_r[10][all_months-1]+variable_r[9][all_months-1]+variable_r[8][all_months-1]+variable_r[7][all_months-1]+variable_r[6][all_months-1]+variable_r[5][all_months-1]+variable_r[4][all_months-1]+variable_r[3][all_months-1]+variable_r[2][all_months-1]+variable_r[1][all_months-1]+variable_r[0][all_months-1])
            zebra += 1
